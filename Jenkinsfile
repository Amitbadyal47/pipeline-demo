pipeline {
    agent any
    environment {
        AWS_ACCOUNT_ID="681555364651"
        AWS_DEFAULT_REGION="us-east-1"
	    CLUSTER_NAME="jenkinsjs"
	    SERVICE_NAME="jenkinsjs"
	    TASK_DEFINITION_NAME="jenkinsjs"
	    DESIRED_COUNT="1"
        IMAGE_REPO_NAME="jenkinsjs"
	    ...
	    registryCredential = "Amitbadyal47"
	    JOB_NAME = "nodejs"
